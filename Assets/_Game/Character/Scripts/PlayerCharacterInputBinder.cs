...
namespace LOK1game
{
    public class PlayerCharacterInputBinder : MonoBehaviour, IPawn
    {
        public Controller Controller => throw new System.NotImplementedException();

        public void Construrct()
        {
